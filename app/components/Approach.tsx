...
// No need for useEffect or useState anymore!
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          ...
          >
            ...
            >
              ...
              <div>
                <motion.span
                    whileInView={{ color: ["#343434", "#EE7722"] }}
                ...
                <motion.span
                    whileInView={{ color: ["#343434", "#EE7722"] }}
                    transition={{ ease: "easeInOut", duration: 0.5, delay: 1.155 }}
                    viewport={{ once: true }}
                >
                  detail
                </motion.span>
                .
                <br />
                {/* THE FIX: Use relative + inline-block + w-fit so it hugs the text perfectly */}
                <div className="relative inline-block w-fit mx-auto mt-2">
                  <span>Detailed by nature</span>
                  <motion.span
                      whileInView={{ width: ["0%", "100%"] }}
                      transition={{ ease: "easeInOut", duration: 0.5, delay: 1.8 }}
                      viewport={{ once: true }}
                      className="absolute bottom-1 left-0 h-[5px] bg-black"
                  ></motion.span>
                </div>
              </div>
            </motion.h2>
            ...
            >
              ...
              We&apos;d rather do four houses a week perfectly than ten houses a
              week passably — and the homes we&apos;ve installed for thirty years
              still seal tight, swing true, and look right.
            </motion.p>
          </motion.div>
